import 'package:app/agenda_screen.dart';
...
class ScaffoldPadres extends StatefulWidget {
  const ScaffoldPadres({super.key});

  @override
  State<ScaffoldPadres> createState() => _ScaffoldPadresState();
}

class _ScaffoldPadresState extends State<ScaffoldPadres> {
            ...
            Form(
              ...
              child: Column(
                children: [
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          decoration: InputDecoration(
                            ...
                            labelText:
                                "CI del Estudiante", // Cambiado label a labelText
                          ),
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          decoration: InputDecoration(
                            border: InputBorder.none,
                            labelText:
                                "Año de la libreta", // Cambiado label a labelText
                          ),
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'Por favor ingrese el año de la libreta';
                            }
                            if (value.length < 4) {
                              return 'El año es de 4 digitos';
                            }
                            return null;
                          },
                        ),
                  ...
                  //       setState(() {
                  //         body = BoletinScreen(
                  //             ciController.text, anioController.text);
                  //       });
                  //     }
                  //   },
                  //   child: Text(
