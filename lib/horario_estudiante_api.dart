...
Future<List<Horario>> fetchHorario(String ci) async {
  final response = await http
      .get(Uri.parse('http://3.144.128.129:8069/api/horario/estudiante/$ci'));
...
class HorarioEstudiante extends StatefulWidget {
  final String ci;

  HorarioEstudiante({required this.ci});

  @override
  _HorarioEstudianteState createState() => _HorarioEstudianteState();
}

class _HorarioEstudianteState extends State<HorarioEstudiante> {
